...
| INTERVENTION     |               | (291.0k pop)  | 2. Stricter geo-hazard clearance requirements for  |
...
| **Data Dictionary** | [`dataset_data_dictionary.md`](dataset_data_dictionary.md) | Granular column definitions, raw source metadata, and lineage documentation. |
